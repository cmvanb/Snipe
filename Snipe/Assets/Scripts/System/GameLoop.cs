...
namespace Snipe
{
	public class GameLoop : MonoBehaviour
	{
		...
		void Awake()
		{
            ...
            resourceManager.AddPath("Sprites/Units/unit_red_A_alive");
            resourceManager.AddPath("Sprites/Units/unit_red_sniper_alive");
            resourceManager.AddPath("Sprites/Units/unit_red_doctor_alive");
            resourceManager.AddPath("Sprites/Units/unit_blue_A_alive");
            resourceManager.AddPath("Sprites/Units/unit_blue_sniper_alive");
            resourceManager.AddPath("Sprites/Units/unit_blue_doctor_alive");
            ...
            spriteManager.AddSprite(SpriteID.ASoldier, "Sprites/Units/unit_red_A_alive");
            spriteManager.AddSprite(SpriteID.ASniper, "Sprites/Units/unit_red_sniper_alive");
            spriteManager.AddSprite(SpriteID.AMedic, "Sprites/Units/unit_red_doctor_alive");
            spriteManager.AddSprite(SpriteID.BSoldier, "Sprites/Units/unit_blue_A_alive");
            spriteManager.AddSprite(SpriteID.BSniper, "Sprites/Units/unit_blue_sniper_alive");
            spriteManager.AddSprite(SpriteID.BMedic, "Sprites/Units/unit_blue_doctor_alive");
